...
import { toggleSidebar } from "@/redux/sidebar/slices";
          ...
          <div className="flex items-center gap-4">
            {user.photo ? (
              <>
                <svg
                  fill="white"
                  className="md:hidden block w-[36px]"
                  xmlns="http://www.w3.org/2000/svg"
                  height="24"
                  viewBox="0 0 24 24"
                  width="24"
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger>
                    <img
                      className="rounded-full p-[1px] border border-gray-700"
                      id="img"
                      draggable="false"
                      alt="Avatar image"
                      height="32"
                  ...
                  <DropdownMenuContent className="text-white bg-[#282828] border border-gray-800">
                    <DropdownMenuLabel>
                      <div className="flex items-center">
                        <img
                          className="rounded-full p-[1px] border border-gray-700 w-[40px] h-[40px]"
                          id="img"
                          draggable="false"
                          alt="Avatar image"
                          height="32"
